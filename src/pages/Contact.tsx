...
const Contact: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300 pt-20">
      {/* Hero Section */}
      <section className="relative min-h-[30vh] flex items-center justify-center bg-gradient-to-br from-eco-green via-eco-green/80 to-eco-green/60 dark:from-gray-900 dark:via-gray-900/90 dark:to-gray-900 transition-colors duration-300">
      ...
      <section className="py-12 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-start">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl shadow p-8">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button type="submit" className="w-full bg-eco-yellow text-eco-green font-bold py-3 rounded-lg hover:bg-yellow-300 dark:hover:bg-eco-yellow/80 dark:bg-eco-yellow dark:text-gray-900 transition">Send Message</button>
              </form>
            )}
          </div>
          ...
          <div className="flex flex-col gap-8">
            <div className="bg-eco-green/90 dark:bg-gray-800 text-white dark:text-eco-yellow rounded-xl shadow p-8 flex flex-col gap-3">
            ...
            <div className="rounded-xl shadow overflow-hidden">
              <MapContainer center={LONDON_COORDS} zoom={13} scrollWheelZoom={true} className="w-full h-48 rounded-xl">
                <TileLayer
